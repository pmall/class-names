...
describe('WhitelistedClassNameCollection', function () {
    ...
    context('when there is no pattern', function () {
        ...
        beforeEach(function () {
            ...
            $this->collection = new WhitelistedClassNameCollection($this->delegate->get());
    ...
    context('when there is at least one pattern', function () {
        ...
        beforeEach(function () {
            ...
            $this->collection = new WhitelistedClassNameCollection(...[
                $this->delegate->get(),
        ...
        it('should return the class names returned by the delegate ->classes() method matching at least one pattern', function () {
